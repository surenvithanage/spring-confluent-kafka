# 🛠️ Setting Up Local Kafka (Confluent) for Local Testing

This guide helps you run a **local Confluent Kafka instance** for development and testing using either Docker or the Confluent CLI.
...
- [Confluent CLI](https://docs.confluent.io/confluent-cli/current/install.html) (optional)
...
```bash
git clone https://github.com/surenvithanage/spring-confluent-kafka
cd spring-confluent-kafka
```


### 2. Start Kafka and Dependencies
```bash
docker-compose -f spring-confluent-kafka/docker-compose.yml up -d
```
